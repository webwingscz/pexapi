...
6. If you did everything correct, https://webwingscz.github.io/pexapi/ will lead to your new docs
...
- Documentation(ReDoc): https://webwingscz.github.io/pexapi/
- SwaggerUI: https://webwingscz.github.io/pexapi/swagger-ui/
- Look full spec:
    + JSON https://webwingscz.github.io/pexapi/swagger.json
    + YAML https://webwingscz.github.io/pexapi/swagger.yaml
- Preview spec version for branch `[branch]`: https://webwingscz.github.io/pexapi/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://webwingscz.github.io/pexapi/ with url from the message: `Server started <url>`
